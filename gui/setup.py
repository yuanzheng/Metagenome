...
class SetupWindow(QWidget, Ui_SetupForm):
    ...
    def __init__(self):
        ...
        self.lineEdit_trimmed_fastq_directory.setText(
        ...
        self.pushButton_searchFastQDataDirectory.clicked.connect(
            self.getFastQDataDirectory
        )
        ...
        self.pushButton_search_trimmed_files.clicked.connect(
            self.getFastQTrimmedOutputDirectory
        )
